    ...
    <div className="min-h-screen flex flex-col bg-white">
      <header className="sticky top-0 z-20 bg-white border-b border-[#e6e6e6]">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
          <Link href="/" className="font-heading text-xl font-bold text-[#1a1a1a] tracking-tight">
            NotoHub
          </Link>
          <nav className="flex items-center gap-5 text-sm">
            ...
            <Link href="/login" className="text-[#6b6b6b] hover:text-[#1a1a1a] transition-colors">
              Sign in
            </Link>
            <Link
              href="/signup"
