    ...
    <div className="min-h-screen bg-[#f9f9f9] flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-sm text-[#6b6b6b] mt-1.5">Create your account</p>
        </div>
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2.5 rounded-lg border text-sm outline-none transition-all font-mono placeholder:text-[#b0b0b0] focus:border-[#1a8917] focus:ring-2 focus:ring-[#1a8917]/10 ${
                  errors.username
